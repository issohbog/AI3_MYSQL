...
-- 0.54를 소수점 아래 둘째 자리에서 반올림 하시오 
SELECT ROUND(0.54, 1) FROM dual;

-- 125.67을 일의 자리에서 반올림 하시오 
SELECT ROUND(125.67, -1) FROM dual;

-- 125.67를 십의 자리에서 반올림 하시오
...
-- 547425.1234 를 소수점 아래 첫째 자리에서 절삭 
SELECT TRUNCATE(547425.1234, 0) FROM DUAL; 


-- 547425.1234 를 소수점 아래 둘째 자리에서 절삭 
SELECT TRUNCATE(547425.1234, 1) FROM DUAL; 


-- 547425.1234 를 일의 자리에서 절삭 
SELECT TRUNCATE(547425.1234, -1) FROM DUAL; 

-- 547425.1234 를 십의 자리에서 절삭 
SELECT TRUNCATE(547425.1234, -2) FROM DUAL; 
