-- Active: 1745889699092@@127.0.0.1@3306@employees
-- 문자열을 대문자로, 소문자로, 첫글자만 대문자로 변환하는 쿼리 작성하기 
-- 원문 : 'AlohA WoRlD~!'
...
SELECT CONCAT_WS(' ', 'ALOHA', 'CLASS')
FROM dual;

-- 사원정보를 '이름/성/생년월일' 형식으로 출력하시오
SELECT CONCAT_WS('/', first_name, last_name, birth_date) '사원 정보'
FROM employees;
...
-- 'wwwaloha@kakao.com' 이메일 주소에서 '@' 문자가 몇번째 위치하는지 출력하시오 
-- LOCATE('찾을 문자', '문자열')
